...
// 特殊行业许可证
PermitProduct = new Meteor.Collection("PermitProduct_wechat");

// 公司变更
CompanyChange = new Meteor.Collection("CompanyChange_wechat");

// 银行描述信息
BankDes = new Meteor.Collection('BankDes_wechat');

//小本子描述信息
LittleBook = new Meteor.Collection('LittleBook_wechat');
