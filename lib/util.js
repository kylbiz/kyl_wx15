// 相关工具
log = console.log.bind(console, "KYLMBDebug(" + moment().format('YYYY-MM-DD HH:mm:ss') + "): ");
...
kylUtil.getProductsDes = function (name) {
    var productsDes = {
        'registration': {img: '/images/product/reg_icon.png', title: '小白云', subTitle: '工商注册系统服务费'}, // 小白云
        'bank': {img: '/images/product/bank_icon.png', title: '小白财税', subTitle: '银行开户服务费'},     // 小白财税
        'finance': {img: '/images/product/f_icon.png', title: '小白财税', subTitle: '财务代理'}, // 小白财税
        'finances': {img: '/images/product/f_icon.png', title: '小白财税', subTitle: '财务代理'}, // 小白财税
        'bookkeeping': {img: '/images/product/f_icon.png', title: '小白财税', subTitle: '流量记账包'}, //小白财税
        ...
        'permit': {img: '/images/product/trademark_icon.png', title: '小白云工商注册', subTitle: '特殊行业许可证'}, // 许可证
        'companycha': {img: '/images/product/trademark_icon.png', title: '小白云工商注册', subTitle: '公司变更服务'}, // 公司变更
    };
...
kylUtil.getImg = function (name) {
    var img = {
        'registration': 'icon_register.png',
        '公司注册': 'icon_register.png',
        ...
        'permit': 'icon_permit.png',   // 许可证
        '食品流通许可证': 'icon_permit.png',   // 许可证
        '食品流通许可证': 'icon_permit.png',   // 许可证
        '进出口权证': 'icon_permit.png', // 许可证

        'companycha': 'icon_companycha.png', // 公司变更
        '公司字号变更': 'icon_companycha.png', // 公司变更
        '内容变更': 'icon_companycha.png', // 公司变更
        '注册地址变更': 'icon_companycha.png', // 公司变更

        // 旧产品
        '投资管理': 'invest.png',
        '1元注册': 'oneyuan.png',
        '新年特惠': 'newyear.png',
        '极速注册': 'icon_register.png',
        '电商公司': 'dianshang.png',
        '教育公司': 'jiaoyu.png',
        '金融信息公司': 'jingrong.png',
...
kylUtil.getProductImg = function (type) {
    var img = {
        'registration': '/images/icon/icon_register.png',
