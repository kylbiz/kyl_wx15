...
kylUtil.getProductsDes = function (name) {
    var productsDes = {
        'registration': {img: '/images/product/reg_icon.png', title: '小白云', subTitle: '工商注册系统', subDes: '服务费'}, // 小白云
        'bank': {img: '/images/product/bank_icon.png', title: '小白财税', subTitle: '银行开户', subDes: '服务费'},     // 小白财税
...
kylUtil.getImg = function (name) {
    var img = {
        ...
        'permit': 'icon_finance.png',   // 许可证
        'companycha': 'icon_finance.png', // 公司变更
